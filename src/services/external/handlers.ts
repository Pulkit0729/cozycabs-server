...
//     let ride;
//     if (rideNo) {
//       ride = await Ride.findOne({ rideNo: Number(rideNo) }).populate<{
//         driver: IDriver;
//       }>('driver');
//     } else if (blabla_ride_id) {
//       ride = await Ride.findOne({ blabla_ride_id: blabla_ride_id }).populate<{
//         driver: IDriver;
//       }>('driver');
//     }
...
//       blabla_ride_id && blabla_ride_id.length == 36
//         ? total
//         : seats * ride.discountedPrice!;
//     const channel =
//       blabla_ride_id && blabla_ride_id.length == 36 ? 'blabla' : 'bot';
...
//     let ride;
//     if (ride_id) {
//       ride = await Ride.findById(ride_id).populate<{ driver: IDriver }>(
//         'driver'
//       );
//     } else if (blabla_ride_id) {
//       ride = await Ride.findOne({ blabla_ride_id: blabla_ride_id }).populate<{
